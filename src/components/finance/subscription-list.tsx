  ...
  return (
    <section className="lofi-panel rounded-lg p-5">
      <div className="mb-4">
        ...
        <h2 className="mt-1 text-xl font-semibold text-stone-100">Active Subscriptions</h2>
      </div>
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <p className="mt-1 flex items-center gap-1 text-xs text-dusk-cyan">
                    ...
                    {new Date(subscription.nextBillingDate).toLocaleDateString()} / {subscription.billingCycle.toLowerCase()}
                  </p>
