...
- Header: title and supporting copy on the left, metrics and one large sticker on the right.
...
- Mobile/tablet: hero content stacks, metrics wrap, and the Upcoming rail moves below the calendar.
